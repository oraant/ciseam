...
urlpatterns = [
    ...
    url(r'^$', eam_v.index),
    url(r'^help/$', eam_v.help),
    url(r'^about/$', eam_v.about),
    ...
    url(r'^update_asset_pre/', eam_v.update_asset_pre),
    url(r'^delete_asset/', eam_v.delete_asset),
    url(r'^insert_asset/', eam_v.insert_asset),
    url(r'^insert_asset_pre/', eam_v.insert_asset_pre),
    ...
    url(r'^update_maintenance_pre/', eam_v.update_maintenance_pre),
    url(r'^delete_maintenance/', eam_v.delete_maintenance),
    url(r'^insert_maintenance/', eam_v.insert_maintenance),
    url(r'^insert_maintenance_pre/', eam_v.insert_maintenance_pre),
    ...
    url(r'^update_usagerecord_pre/', eam_v.update_usagerecord_pre),
    url(r'^delete_usagerecord/', eam_v.delete_usagerecord),
    url(r'^insert_usagerecord/', eam_v.insert_usagerecord),
    url(r'^insert_usagerecord_pre/', eam_v.insert_usagerecord_pre),
]
